#include "include/cthsm_state_v2.hpp"
#include <iostream>
#include <cassert>
...
int main() {
    std::cout << "CTHSM - Testing state() method with macro approach\n";
    std::cout << "==================================================\n\n";
    ...
    // Create state machine with wrapper functionality
    auto sm = create_wrapper(model);
    
    std::cout << "Testing state() syntax with macro:\n\n";
    ...
    std::cout << "\nThe macro approach provides the exact syntax requested!\n";
