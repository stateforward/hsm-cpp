...
TEST_CASE("Behaviors - Entry/Exit/Effect") {
  constexpr auto model = define(
      "machine", initial(target("state_a")),
      state("state_a", entry(entry_a), exit(exit_a),
...
TEST_CASE("Behaviors - Guards") {
  constexpr auto model =
      define("machine", initial(target("start")),
             state("start",
...
TEST_CASE("Behaviors - Hierarchy Order") {
  constexpr auto model =
      define("machine", initial(target("p/c")),
             state("p", entry(entry_a), exit(exit_a),
