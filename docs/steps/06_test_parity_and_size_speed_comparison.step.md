...
* [x] **Port remaining `hsm` tests to `cthsm`**
...
* [x] **Ensure zero-regression combined test suite**
...
* [x] **Design benchmarks for size and speed comparison**
...
* [x] **Measure and compare code size**
...
* [x] **Measure and compare runtime performance**
...
* [x] **Summarize results and update documentation**
